...
export default function SidebarThemeSettings() {
  ...
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div className="h-full px-4 py-8 overflow-y-auto bg-[#f8fafc] border-r border-gray-100 relative" data-custom-component="SidebarBackground" data-customizable-id="sidebar-bg" data-customizable-type="bg">
        ...
        <button
          ...
          type="button"
          className="sm:hidden absolute top-4 right-4 p-1.5 rounded-xl hover:bg-gray-100 text-gray-500 cursor-pointer"
        >
